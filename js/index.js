...
require(['FFF','picture'],function(FFF,Picture){
	...
	pictureList[1] = new Picture.Picture({
			img:'img/1.png',
			gif:'img/1.png',
			tag:['black','dark','hehe'],
	});
	pictureList[1].render({
			container:$('.picture_list'),
			type:'append',
	});

	pictureList[2] = new Picture.Picture({
			img:'img/2.png',
			gif:'img/2.png',
			tag:['black','dark','hehe'],
	});
	pictureList[2].render({
			container:$('.picture_list'),
			type:'append'
	});

	pictureList[3] = new Picture.Picture({
			img:'img/3.png',
			gif:'img/3.png',
			tag:['black','dark','hehe'],
	});
	pictureList[3].render({
			container:$('.picture_list'),
			type:'append'
	});
